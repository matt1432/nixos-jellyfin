...
{fetchNuGet}: [
  ...
  (fetchNuGet {
    ...
    version = "1.2.0";
    hash = "sha256-wA1+QL10lIDrXUz/gZpgQDXiAEBFBUuS4u57ZVkmo0g=";
  })
  (fetchNuGet {
  ...
  (fetchNuGet {
    ...
    version = "4.5.0";
    hash = "sha256-HHiKG5MnGzRwZLBkAS9+tjMxKyigwaOZ904eZLF9VII=";
  })
  (fetchNuGet {
    pname = "ExCSS";
    version = "4.2.3";
  ...
  (fetchNuGet {
    pname = "libse";
    version = "4.0.5";
    hash = "sha256-20gH5Fan380hptOcfy1tIphecUuZXFLzJvMEixyfMbo=";
  })
  (fetchNuGet {
    pname = "LrcParser";
    version = "2023.524.0";
